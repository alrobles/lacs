...
test a lacs model as a benchmark in classification. We use true positive
rate metric (precision) to classify this dataset. We consider all these
articles as positive class papers because they contain information on
parasite-host interactions. Our lacs model is trained to find papers
with this information. The original dataset is stored in
