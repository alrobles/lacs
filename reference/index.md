...
- [`hp3_abstracts`](https://alrobles.github.io/lacs/reference/hp3_abstracts.md)
  ...
  We use true positive rate metric (precision) to classify this dataset.
  We consider all these articles as positive class papers because they
  contain information on parasite-host interactions. Our lacs model is
  trained to find papers with this information. The original dataset is
  stored in 10.5281/zenodo.596810 and the clover curated dataset was
  retrived from 10.5281/zenodo.4435127
